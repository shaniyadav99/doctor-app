      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">HealthHub</h3>
            <p className="text-gray-300 text-sm">
              Your trusted healthcare partner. We connect you with top medical professionals
              to provide comprehensive care and support for your well-being.
            </p>
          </div>
          <div>
